...
// GetMessageByIDParams contains all the bound params for the get message by Id operation
...
//
// To ensure default values, the struct must have been initialized with NewGetMessageByIDParams() beforehand.
func (o *GetMessageByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
